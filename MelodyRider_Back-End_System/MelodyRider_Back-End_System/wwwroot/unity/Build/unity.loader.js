function createUnityInstance(t, r, d) {
    ...
    function n(e) {
        ...
        (r += "\n" + (n = n.startsWith(r) ? n.substring(r.length) : n).trim()) &&
            ...
            C(r, e.filename || (t && (t.fileName || t.sourceURL)) || "", e.lineno || (t && (t.lineNumber || t.line)) || 0);
    }
    function e(e, t, r) {
        var n = e[t];
            ...
            printErr: function (e) {
                console.error(e),
                    ...
                    (-1 != e.toLowerCase().indexOf("mime")
                        ? i('HTTP Response Header "Content-Type" configured incorrectly on the server for file ' + c.codeUrl + ' , should be "application/wasm". Startup time performance will suffer.', "warning")
                        : i(
        ...
        w =
            (document.addEventListener("webkitfullscreenchange", function (e) {
                document.webkitCurrentFullScreenElement === t
                    ? t.style.width && ((y = t.style.width), (v = t.style.height), (t.style.width = "100%"), (t.style.height = "100%"))
        ...
        -1 == e.indexOf("fullscreen error") &&
            (c.startupErrorHandler
                ...
                (console.log("Invoking error handler due to\n" + e),
                    ...
                    (-1 != (e = "An error occurred running the Unity content on this page. See your browser JavaScript console for more info. The error was:\n" + e).indexOf("DISABLE_EXCEPTION_CATCHING")
                        ? (e =
                        ...
                        : -1 != e.indexOf("Cannot enlarge memory arrays")
                            ...
                            : (-1 == e.indexOf("Invalid array buffer length") && -1 == e.indexOf("Invalid typed array length") && -1 == e.indexOf("out of memory") && -1 == e.indexOf("could not allocate memory")) ||
    ...
    function x(e, t) {
        if ("symbolsUrl" != e) {
            var r = c.downloadProgress[e],
                n =
                    ((r = r || (c.downloadProgress[e] = { started: !1, finished: !1, lengthComputable: !1, total: 0, loaded: 0 })),
                        "object" != typeof t ||
                        ("progress" != t.type && "load" != t.type) ||
                        (r.started || ((r.started = !0), (r.lengthComputable = t.lengthComputable)), (r.total = t.total), (r.loaded = t.loaded), "load" == t.type && (r.finished = !0)),
                        0),
                o = 0,
                a = 0,
                s = 0,
        ...
        o.isConnected = new Promise(function (t, r) {
            try {
                ...
                (e.onupgradeneeded = function (e) {
                    var t;
                    (e = (e = e).target.result).objectStoreNames.contains(h.name) || e.createObjectStore(h.name),
    ...
    function P(e, t, r, n, o) {
        var a = { url: e, version: m.version, company: t, product: r, updated: n, revalidated: n, accessed: n, response: { headers: {} } };
        return (
            o &&
    ...
    function U() {
                                ...
                                return (
                                    ...
                                    "file:" == location.protocol
                                        ...
                                        : ((r +=
                                            ...
                                            ((n = -1 != ["localhost", "127.0.0.1"].indexOf(location.hostname) ? "" : "Migrate your server to use HTTPS."),
        ...
        x((r = "dataUrl")), (e = c.cacheControl(c[r])), (t = c.companyName && c.productName ? c.cachedFetch : c.fetchWithProgress), (n = c[r]), (n = /file:\/\//.exec(n) ? "same-origin" : void 0);
        var r,
            e,
            t,
            n,
            o = t(c[r], {
                ...
                .catch(function (e) {
                    ...
                    "file:" == location.protocol
                        ? i(t + ". Loading web pages via a file:// URL without a web server is not supported by this browser. Please use a local development web server to host Unity content, or use the Unity Build and Run option.", "error")
                        : console.error(t);
                });
    ...
    return (
        (c.SystemInfo = (function () {
            ...
            var u = { "NT 5.0": "2000", "NT 5.1": "XP", "NT 5.2": "Server 2003", "NT 6.0": "Vista", "NT 6.1": "7", "NT 6.2": "8", "NT 6.3": "8.1", "NT 10.0": "10" }[u] || u,
                c =
                    ((c = document.createElement("canvas")) &&
                        ((gl = c.getContext("webgl2")),
                            (glVersion = gl ? 2 : 0),
                            gl || ((gl = c && c.getContext("webgl")) && (glVersion = 1)),
                            gl && (n = (gl.getExtension("WEBGL_debug_renderer_info") && gl.getParameter(37446)) || gl.getParameter(7937))),
        ...
        (c.readBodyWithProgress = function (a, s, i) {
            var e = a.body ? a.body.getReader() : void 0,
                ...
                f = 0;
            return (
                d || console.warn("[UnityCache] Response is served without Content-Length header. Please reconfigure server to include valid Content-Length for better download performance."),
                (function o() {
                    return void 0 === e
                        ? a.arrayBuffer().then(function (e) {
                            var t = new Uint8Array(e);
                            return s({ type: "progress", response: a, total: e.length, loaded: 0, lengthComputable: d, chunk: i ? t : null }), t;
                        })
                        : e.read().then(function (e) {
                            ...
                            return (
                                h + e.value.length <= u.length ? (u.set(e.value, h), (f = h + e.value.length)) : c.push(e.value),
                                (h += e.value.length),
                                s({ type: "progress", response: a, total: Math.max(l, h), loaded: h, lengthComputable: d, chunk: i ? e.value : null }),
                                o()
                            );
                        });
                })().then(function (e) {
                    return s({ type: "load", response: a, total: e.length, loaded: e.length, lengthComputable: d, chunk: null }), (a.parsedBody = e), a;
                })
            );
        }),
        ...
        (c.UnityCache =
            ((l = { name: "UnityCache", version: 3 }),
                ...
                (f = window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB),
                                ...
                                function (t, r) {
                                    try {
                                        ...
                                        null === this.database
                                            ...
                                            : ((e = -1 != ["put", "delete", "clear"].indexOf(s) ? "readwrite" : "readonly"),
                                                (n = this.database.transaction([a], e).objectStore(a)),
                                                "openKeyCursor" == s && ((n = n.index(i[0])), (i = i.slice(1))),
            ...
            ((g = c.UnityCache),
                ...
                function (n, o) {
                    var e,
                        ...
                        s = { enabled: ((e = r), (!(t = o) || !t.method || "GET" === t.method) && (!t || -1 != ["must-revalidate", "immutable"].indexOf(t.control)) && !!e.match("^https?://")) };
                    function i(e, t) {
                                ...
                                if (304 === e.status)
                                    return (
                                        ...
                                        a
                                            ...
                                            .then(function () {
                                                T("'" + s.result.url + "' successfully revalidated and served from the indexedDB cache");
                                            })
                                            .catch(function (e) {
                                                T("'" + s.result.url + "' successfully revalidated but not stored in the indexedDB cache due to the error: " + e);
                                            }),
                                ...
                                200 == e.status
                                    ? ((s.result = P(e.url, s.company, s.product, s.accessed, e)),
                                        ...
                                        a
                                            .storeRequest(s.result)
                                            .then(function () {
                                                T("'" + s.result.url + "' successfully downloaded and stored in the indexedDB cache");
                                            })
                                            .catch(function (e) {
                                                T("'" + s.result.url + "' successfully downloaded but not stored in the indexedDB cache due to the error: " + e);
                                            }))
                                    : T("'" + s.result.url + "' request failed with status: " + e.status + " " + e.statusText);
                            }
                            return e;
                        });
                    }
                    function d(e) {
                        o &&
                            o.onProgress &&
                            (o.onProgress({ type: "progress", total: e.parsedBody.length, loaded: e.parsedBody.length, lengthComputable: !0 }),
                                o.onProgress({ type: "load", total: e.parsedBody.length, loaded: e.parsedBody.length, lengthComputable: !0 }));
                    }
                    return (
                        o && ((s.control = o.control), (s.company = o.company), (s.product = o.product)),
                            ...
                            ? a
                                ...
                                .then(function (e) {
                                    ...
                                    return "immutable" == s.control
                                        ? ((s.revalidated = !0), a.storeRequest(s.result), T("'" + s.result.url + "' served from the indexedDB cache without revalidation"), d(r), r)
                                        : ((e = s.result.url),
                                            ((t = window.location.href.match(/^[a-z]+:\/\/[^\/]+/)) && !e.lastIndexOf(t[0], 0)) || (!r.headers.get("Last-Modified") && !r.headers.get("ETag"))
                                                ? ((e = (o = o || {}).headers || {}),
                                                    (o.headers = e),
                                                    r.headers.get("Last-Modified")
                                                        ? ((e["If-Modified-Since"] = r.headers.get("Last-Modified")), (e["Cache-Control"] = "no-cache"))
                                                        : r.headers.get("ETag") && ((e["If-None-Match"] = r.headers.get("ETag")), (e["Cache-Control"] = "no-cache")),
                                                    i(n, o))
                                                : fetch(s.result.url, { method: "HEAD" }).then(function (t) {
                                                    return (
                                                        (s.revalidated = ["Last-Modified", "ETag"].every(function (e) {
                                                            return !r.headers.get(e) || r.headers.get(e) == t.headers.get(e);
                                                        })),
                                                        s.revalidated
                                                            ? ((s.result.revalidated = s.result.accessed), a.storeRequest(s.result), T("'" + s.result.url + "' successfully revalidated and served from the indexedDB cache"), d(r), r)
                                                            : i(n, o)
                                                    );
                                                }));
                                })
                                .catch(function (e) {
                                    return T("Failed to load '" + s.result.url + "' from indexedDB cache due to the error: " + e), b(n, o);
                                })
                            : b(n, o)
                    );
                })),
